...
%
% 4. 论文题目 proposed-title:
%      此为报告第 3 页表格中的论文题目。
%      较长题目会根据表格列宽自动换行，
%      但如果需要手动换行，可以使用 \newline 命令。
%
% 5. 课题来源 research-sources:
%      此为报告第 3 页表格中的课题来源，
%      将对应选项设置为 true 即可勾选。
%
% 6. 论文开题日期 proposal-date:
%      此为报告第 3 页表格中的论文开题日期，
%      必须填写，不会自动使用当前日期。
%
% 7. 文件末尾签名:
...
\sjtuformsetup{
  ...
  degree-program = 学术型 Academic,
  date           = {},
  % 以下为第 3 页表格信息
  proposed-title = {我的很长很长很长很长很长很长很长很长很长的很厉害的论文题目},
  research-sources = {
