\documentclass[zihao=-4,a4paper,AutoFakeBold]{ctexart}
...
\usepackage{makecell}
\usepackage{tikz}
\usepackage[maxbibnames=9]{biblatex} % 可使用 style=gb7714-2015 选项来指定参考文献国标样式，但官方模板对此未做要求
...
% 楷体，行距\linespread{1.75}的设置为与word仔细比对后选取的经验值
...
% 也可以用 wasysym 等宏包里提供的 \checked 等命令
\begin{table}[h]
    \centering
    \linespread{1.5}
    \zihao{-4}
...
\vspace{\baselineskip}
\noindent
{\bfseries\fangsong 本人承诺：开题报告中的内容真实无误，若有不实，愿承担相应的责任和后果。I hereby declare and confirm that the details provided in this Form are valid and accurate. If anything untruthful found, I will bear the corresponding liabilities and consequences.}
