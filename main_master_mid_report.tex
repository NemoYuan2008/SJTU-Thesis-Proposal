%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 上海交通大学硕士中期检查报告 LaTeX 模板
% SJTU Master Mid-term Report LaTeX Template
% 使用时请仔细阅读注释并按照要求填写
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 加载模板样式文件
\usepackage{styles/sjtu-mid-report}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% 1. 学生类别 Degree Program (请填写以下两个中的一个):
%      学术型硕士生 Academic Master
%      专业型硕士生 Professional Master
%
% 2. 学习形式 Study Mode (请填写以下两个中的一个):
%      全日制 Full-time
%      非全日制 Part-time
%
% 3. 考核日期:
...
\name{我的名字}
\degreeprogram{专业型硕士生 Professional Master}
