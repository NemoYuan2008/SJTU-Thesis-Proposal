...
\begin{center}
    \bfseries\songti
    \vspace{-1.0cm}
    \zihao{1} 硕士研究生学位论文中期检查报告\par
    \zihao{-3} Mid-term Examination Report for SJTU Master Student
    \vspace{0.5cm}
\end{center}
...
% 1. 学生类别 Degree Program 中应填写以下 2 个中的一个
%       a. 学术型硕士生 Academic Master
%       b. 专业型硕士生 Professional Master
...
$
\vcenter{\hbox{\includegraphics[height=0.5cm, keepaspectratio]{figures/your_signature.png}}}  % 插入签名图片
$
\hfill              
日期/Date： 20YY-MM-DD
