...
% 仿宋加粗、悬挂缩进，同时设置后续正文的字体、行距、段间距
% 使用示例见正文
\renewcommand*{\section}[1]{%
    \par\vspace{12pt}\refstepcounter{section}%
    \fangsong\bfseries\linespread{1.25}\selectfont\hangpara{18pt}{1}%
    \thesection 、#1\par%
    \normalfont\kaishu\setlength{\parskip}{0.5\baselineskip}\linespread{1.75}\selectfont}
...
\renewcommand*{\subsubsection}[1]{\refstepcounter{subsubsection}%
    \par\noindent\textbf{\thesubsubsection\quad#1}\par}
...
\bfseries\fangsong% 剩下的所有内容均为仿宋加粗
\noindent
